  ...
  return (
    <>
      <div className="form-card">
        <div className="row">
          <div className="col-7">
            <h2 className="fs-title">Basic RV Info</h2>
          </div>
          <div className="col-5">
        ...
        <div className="row">
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">VIN: *</label>
            <input
              type="text"
              name="vin"
            ...
            {errors.vin && touched.vin && (
              <p classNameName="text-danger">{errors.vin} </p>
            )}
          </div>
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Type: *</label>
            <select
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Make: *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="make"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Model: *</label>
            <input
              type="text"
              name="model"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Year: *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="year"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Sleeps: *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="sleep"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Slides: *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="slides"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Seatbelts: *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="seatbelts"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Mileage: *</label>
            <input
              type="number"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Length (ft.): *</label>
            <select
              className="form-select"
              aria-label="Default select example"
              name="length"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Weight (lb.): *</label>
            <input
              type="number"
          ...
          <div className="col-md-4 mb-3">
            <label className="fieldlabels">Value (USD): *</label>
            <input
              type="number"
