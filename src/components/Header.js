  ...
  <div className="container">
    ...
    <ul className="navbar-nav  mb-2 mb-lg-0">
        <li className="nav-item">
          <NavLink to="/" className="nav-link " aria-current="page" href="#" onClick={collapseNav}>
            Home
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink  to="/listRV" className="nav-link" onClick={collapseNav}>
          list my rv
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/rvs-for-rent" className="nav-link" onClick={collapseNav}>
          Search
          </NavLink>
        </li>
        <li className="nav-item">
          <NavLink to="/contact-us" className="nav-link" onClick={collapseNav}>
          Contact
          </NavLink>
        </li>
   ...
   <li className="nav-item">
     <NavLink to="/login" className="nav-link log" onClick={collapseNav}>
    Login
     </NavLink>
   </li>
   <li className="nav-item">
     <NavLink to="/signup" className="nav-link reg" onClick={collapseNav}>
    Sign up
     </NavLink>
   </li>
   <li className="nav-item">
    ...
    <div className="dropdown header-profile-dropdown">
     ...
     <img src={profile}/>
        ...
        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li>
                <NavLink to="/account-settings" className="dropdown-item" onClick={collapseNav}>
                    Settings
                </NavLink>
            </li>
            <li>
                <NavLink to="/booking" className="dropdown-item" onClick={collapseNav}>
                    Bookings
                </NavLink>
            </li>
            <li>
